...
def inception_activations(images=inception_images, num_splits=1):
    ...
    print("INSTANTIATED ACTIVATIONS FOR FID")
    return activations
...
def get_inception_activations(inps):
    ...
    for i in range(n_batches):
        ...
        act[i * BATCH_SIZE: i * BATCH_SIZE

                            + min(BATCH_SIZE, inp.shape[0])] = session.run(activations, feed_dict={
